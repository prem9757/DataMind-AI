        ...
        <div className="space-y-4">
          ...
          >
              ...
              <div className="space-y-2 max-w-2xl">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-amber-400 uppercase tracking-widest font-mono">
                    Smart Data Analysis Assistant • Autonomous Executive Briefing
                  </span>
                </div>
            ...
            <div className="border-t border-[#252A36] pt-6 text-center text-xs text-slate-500 font-mono">
              Generated by Smart Data Analysis Assistant Engine • Confidential &amp; Proprietary • 100% Deterministic Fact Verification
            </div>
          </div>
        </div>
      )}
